...
public class ScoreWidget extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        views.setOnClickPendingIntent(R.id.test_button, pendingIntent);

        Intent service = new Intent(context, ScoreWidgetService.class);
        views.setRemoteAdapter(R.id.scores_widget_list, service);
